...
public class BillremindersActivity extends AppCompatActivity {
    ...
    private void saveBillToFirebase(Bill bill, String date) {
        ...
        firebaseDatabase.getReference("Users")
                ...
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(BillremindersActivity.this, "Bill saved and reminder set successfully", Toast.LENGTH_SHORT).show();
    ...
    private void setReminder(String dateStr) {
        try {
            ...
            if (date == null) {
                Log.e("BillReminders", "Parsed date is null.");
                return;
            }
            ...
            if (alarmManager != null) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S && !alarmManager.canScheduleExactAlarms()) {
                    ...
                    Toast.makeText(this, "Grant exact alarm permission to proceed", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                Log.d("BillReminders", "Reminder set for: " + dateStr);
            } else {
                Log.e("BillReminders", "AlarmManager is null.");
            }
        } catch (Exception e) {
            Log.e("BillReminders", "Failed to set reminder: " + e.getMessage());
