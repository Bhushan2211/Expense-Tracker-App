...
public class CategoryAdapter extends  RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    public interface OnCategoryLongClickListener {
        void onCategoryLongClicked(CategoryModel category);
    }


    public CategoryAdapter(List<CategoryModel> categoryList, OnCategoryClickListener clickListener,  OnCategoryLongClickListener longClickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnLongClickListener(v -> {
            if (longClickListener != null) {
                longClickListener.onCategoryLongClicked(category);
                return true;
            }
            return false;
        });
